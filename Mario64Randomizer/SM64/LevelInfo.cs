...
namespace Mario64Randomizer.SM64
{
    ...
    {
        public int LevelScriptEntryPoint { get { return 0x2AC094 + ROMOffset * 20; } }
    ...
    public class LevelInfo
    {
        ...
        public static readonly LevelOffsetsDescription[] Description = {
        ...
        public static LevelOffsetsDescription FindByLevelScriptEntryPoint(int levelScriptEntryPoint)
        {
            if (IsValidLevelScriptEntry(levelScriptEntryPoint))
                return Array.Find(Description, descr => descr.LevelScriptEntryPoint == levelScriptEntryPoint);
            else
                return null;
        }

        private static bool IsValidLevelScriptEntry(int levelScriptEntryPoint)
        {
